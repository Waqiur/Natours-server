...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoid2FxaXVyIiwiYSI6ImNtOGp6YW1uejB0dTUya3E2dDlxdHQ3dzIifQ.Op48oUl9vfJ7doDLNGJCQQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/waqiur/cm8k2m2xp017u01sa6efce385',
    // style URL
    scrollZoom: false
  });
...
},{"./alert.js":"alert.js","axios":"../../node_modules/axios/index.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51R5pnzSI5C3ay7zvF4L8bwscDlcf1nil5Css133IRG7zo5kd973MYXdjySXIyfgrNo2I8IBtHLYkBvaoGD9SRpGZ00yu0qnp9c');
